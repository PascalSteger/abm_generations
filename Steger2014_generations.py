...
epsilon = 0.25         # Epsilon: threshold for interaction based on opinion difference
...
Tmax = 300            # Number of steps to simulate
...
class BCGenerations():
    ...
    def show_variability(self):
        ...
        ax.hist(DeltaT, int(Tmax/3), weights=wei, alpha=0.7, color='black')#2*np.sqrt(self.pop.runningGroupID))
